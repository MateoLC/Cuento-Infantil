...
const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 group flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-[#25D366] text-white rounded-full shadow-2xl hover:bg-[#20bd5a] hover:scale-110 active:scale-95 transition-all duration-300"
