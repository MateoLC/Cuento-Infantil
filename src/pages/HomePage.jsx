      ...
      >
        ...
        <div className="relative w-full min-h-[auto] md:min-h-[calc(100vh-5rem)] overflow-hidden bg-[#F5EFE6]">
          <video
            ...
            muted
            playsInline
            poster="/assets/sofia-hero-1440.webp"
            className="w-full h-auto md:absolute md:inset-0 md:w-full md:h-full object-cover object-center md:object-top"
          >
            <source src="/assets/sofia-hero-boomerang.mp4" type="video/mp4" />
          </video>
